package com.capgemini.casestudy;
	...
	import com.capgemini.casestudy.model.Department;
	import com.capgemini.casestudy.model.Employee;
import com.capgemini.casestudy.service.EmployeeRepository;
	...
	public class MainClass {
		public static void main(String[] args) throws ParseException {
			...
			do {
				...
				System.out.println("Enter 13 to Create a method to accept first name and last name of manager to print name of all his/her subordinates.");
				System.out.println("Enter 14 to Sort employees by their: Employee id,Department id,First name");
